...
INSTALL_DIR="${INSTALL_DIR:-$XDG_DATA_HOME/auto-penguin-setup}"
SRC_DIR="$INSTALL_DIR/autocomplete"
LOG_DIR="$XDG_DATA_HOME/auto-penguin-setup/logs"

# Defaults
FORCE=false
DRY_RUN=false

MARKER_START="# >>> aps completion start >>>"
MARKER_END="# <<< aps completion end <<<"
...
update_bash_completion() {
  ...
  dst_dir="$XDG_DATA_HOME/aps/autocomplete"

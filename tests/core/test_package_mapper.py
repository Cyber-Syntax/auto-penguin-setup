...
class TestPackageMapping:
    ...
    def test_is_official(self) -> None:
        ...
        mapping = PackageMapping(
            original_name="git", mapped_name="git", source="official"
        )
    ...
    def test_get_repo_name_flatpak(self) -> None:
        ...
        mapping = PackageMapping(
            original_name="test", mapped_name="test", source="flatpak:flathub"
        )
...
class TestPackageMapper:
    ...
    def test_load_arch_mappings(
        self, sample_pkgmap_ini: Path, arch_distro: DistroInfo
    ) -> None:
    ...
    def test_parse_aur_mapping(
        self, tmp_path: Path, arch_distro: DistroInfo
    ) -> None:
    ...
    def test_parse_official_mapping(
        self, tmp_path: Path, fedora_distro: DistroInfo
    ) -> None:

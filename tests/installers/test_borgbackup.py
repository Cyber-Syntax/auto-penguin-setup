...
from aps.installers.borgbackup import BorgbackupInstaller


class TestBorgbackupInstallerInit:
    """Test BorgbackupInstaller initialization."""
...
class TestBorgbackupInstall:
    """Test BorgbackupInstaller install method."""
